...
import { ActivityIndicator, Alert, View, TextInput, Picker, Image, Text, KeyboardAvoidingView, TouchableOpacity, ScrollView } from 'react-native';
 ...
 class FormPengelola extends React.Component {
  ...
  submit(){
    ...
    if(this.state.listrik == ''){
      ...
      console.log('pengeluaran', financing)
    }
  }
};
